                ...
                <form id="filter">
                    <div class="row">
                        <div class="col-3">
                            ...
                            <input type="text" class="form-control datetimepicker" data-pickertype="date"
                                   name="startDate" id="startDate">
                        </div>
                        <div class="col-3">
                            <label for="endDate"><spring:message code="meal.endDate"/></label>
                            <input type="text" class="form-control datetimepicker" data-pickertype="date" name="endDate"
                                   id="endDate">
                        </div>
                        <div class="offset-2 col-2">
                            <label for="startTime"><spring:message code="meal.startTime"/></label>
                            <input type="text" class="form-control datetimepicker" data-pickertype="time"
                                   name="startTime" id="startTime">
                        </div>
                        <div class="col-2">
                            <label for="endTime"><spring:message code="meal.endTime"/></label>
                            <input type="text" class="form-control datetimepicker" data-pickertype="time" name="endTime"
                                   id="endTime">
                        </div>
                    </div>
                </form>
